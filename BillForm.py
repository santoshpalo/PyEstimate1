...
if __name__ == "__main__":
    ...
    print('-'*80)
    print('Case Record No/Year:-___________')
    print('''Name of work:Construction of C.C. road from NuaBasti MaliPada to Shiv Mandir Road
''')
    print('Head of Account:-T.F.C.(2015-16)')
    print('Estimated Cost:-\u20B9300,000.00')
    print('Serial number of this bill:-1st F / A bill')
    print('Date of commencement of the work:-______________\tM.B. No. :-1/Baunsuni G.P.')
    print('Date of completion of the work:-________________\tPage No. :-17-21')
    print('Name of the executant/V.L.L.:-Departmental\n')
    print('\t\tACCOUNT OF WORK DONE OR SUPPLY MADE')
    print('-'*80)
    bill = BillForm([[1.89,d['efhs'],'cum',103.2],[7.35,d['fill_sand'],'cum',313.52],[17.25,d['cc(1:3:6)'],'cum',3700.47],
                    [14.73,d['cc(1:2:4)'],'cum',4814.96],
                     [17.64,d['plinth'],'sqm',82.05],
                     
                     
                     
                    #===========================================================
                    # [7.17,d['20cp'],'sqm',120.23],
                    #===========================================================
                    #===========================================================
    ...
    bill.body()
    #===========================================================================
    # print('\t\t\t\tAdd amount of 2nd R / A bill = \u20B91,94,541.00')
    # print('\t\t\t\t\t\tTotal Amount = \u20B92,14,123.00.00')
    #===========================================================================
    print('\t\t\t\tTotal Amount limited to = \u20B91,39,000.00')
    #===========================================================================
    # print('\t\t\tDeduct amount of 1st R / A bill = (-)\u20B91,94,541.00')
    # print('\t\t\t\tAmount of 2nd R / A bill = \u20B919,582.00')
    #===========================================================================
    #===========================================================================
    # print('\t\t\t\tDeduct less amount @ .02 % = \u20B9223.00')
    # print('\t\t\t\tGross payable amount =\u20B911,17,160.00    ')
    #===========================================================================
    x = deduction([['E.G.B.',610],
                   ['VAT',762],
                   ['Royalty',2689],
                   ['Cess',1390],
                   ['W.C.',1390],
