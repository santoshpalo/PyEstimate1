...
if __name__ == "__main__":
    ...
    b = material_labour('rcc',5.22)
    c = material_labour('cc148',0)
    d = material_labour('rscscolumn',19.53)
    e = material_labour('rscsplinth',0)
    f = material_labour('efhs',0)
    g = material_labour('hysd',4.88)
    ...
    o = material_labour('rscsslab',26.75)
    p = material_labour('rscswalls',0)
    q = material_labour('20cp(1:4)',33.55)
