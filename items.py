...
strength not less than 75Kg/cm2 with dimensional tolerance ± 8 percent cement
mortar (1:6) in super structure\n''',
'12cp(1:6)':'''\n12mm thick cement mortar plaster (1:6) on brick masonry walls
including cost, conveyance and royalty etc. complete. \n''',
'16cp(1:6)':'''\n16mm, thick cement mortar plaster (1:6) on brick masonry walls
including cost, conveyance and royalty etc. complete. \n''',
...
conveyance and royalty etc. complete.\n''',
'CC(1:5:10)':'''\nCement concrete (1:5:10) using 40mm size h.g. metal including cost,
conveyance and royalty etc. complete.\n''',


'wpcp':'''\nFinishing walls with water proofing cement paintincluding all labour
cost and T & P etc. complete.\n''',
'msdoor':'\nSupplying and fixing of M.S. doors and windows in proper position etc. complete\n',
'paint':'''\n2 coats of painting over a coat of priming including T & P and
labour charges etc. complete.\n''',
'asfloor':'''\n2.5cm thick A.S. flooring using c.c. (1:2:4) with 12 mm size c.b.g. chips
including cost, conveyance and royalty etc. complete.\n''',
'vitrified':'''\nSupplying, fitting and fixing vitrified tile in floors of size 600mm x 600mm
of approved make with application of polymer modifiedcement based water
resistant adhesive bed of required thickness of 10mm and filling joints
with epoxy grout of approved quality including cost of all materials,
labour T&P etc required for the work.\n''',
'walltile':'''\nFixing tiles in dados skirting and risers of stepson 12mm thick cement
