...
'distemper':'''\nDistempering two coats to walls with distemper of approved shade on new work to give an even shade exculding cost of distemper.\n''',
'wall_paint':'''\nWall painting 2 coats with weather coat paint of approved shade on new work to give an even shade exculding cost of paint\n''',
'sand_fill':'''\nFilling sand in foundation and plinth well watered and rammed including cost, conveyance and royalty etc. complete.\n''',
'subbase':'''Labour for laying sub-base in layers not exceeding 100mm watering and compacting to the required density in O.M.C with PRR but excluding cost and conveyance of sub base materials\n''',
...
'floor tile':'''Fixing tiles in floors treads or steps and landing on 25mm thick bed of cement mortar 1:1 (1cement : 1sand) jointed with neat cement slury mixed with pigment to match the shades of the tiles including rubbing & polishing complete excluding cost of precast tiles''',
'wall tile':'''\n Fixing tiles in dados skirting and risers of steps on 12mm thick cement plaster (1:3) jointed with neat cement slurry mixed with pigments to match the shade of the tiles including rubbing and polishing complete excluding cost of precast tiles.'''
