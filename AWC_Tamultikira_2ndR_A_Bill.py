...
if __name__ == "__main__":
    ...
    rcc.volume()
    print(it.items['bmss'])
    brick = cl.Quantity([['all walls',1,49.6-12*0.25-0.5,0.45],
                         ['extra height 1',6,3.23,0.25,0.3],
                         ['extra height 2',1,3.65,0.25,0.3],
                         ['extra height 3',2,1.75,0.25,0.3]])
    brick.rate = 100
    brick.volume()
    ...
    lintel= cl.Quantity([['effective centre line length',2,49.6-4*0.25,0.15],
                     ...
                     ['bottom of door 1',1.08,0.25],
                     ['bottom of door 2',3,0.9,0.25],
                     ['bottom of door3',2,0.75],
    ...
    reinforcement=cl.Quantity([['long walls1',4,9.9+.17,0.62],
                               ...
                               ['stirrups in lintel bend',9.9/0.15+6.59/.15+6.88/.15+3.45+2.69-.08+2.95-.08+1.9/.15,0.67,.395],
                               ['beam stirrups',3.23/.15,0.87,.395],
                               ...
                               ['store room chajja bars',3,0.45+.25-.08,0.395],
